import random
import time
from dune.classes_and_functions_monsters import random_action, direction_variants_identification, action_straight, casual_turn, MonsterCat, playfield_creation, MonsterDog
